...
<div class="fiche-body">
    ...
    <div class="fiche-section">
        <h3>🌿 Plantes qui contiennent ce composant <span style="font-size:0.8rem;color:var(--texte-light);font-family:var(--font-sans);font-weight:400;"><?= count($plantes) ?></span></h3>
    ...
    <?php if (!empty($vertus)): ?>
    <div class="fiche-section">
        <h3>✨ Vertus associées <span style="font-size:0.8rem;color:var(--texte-light);font-family:var(--font-sans);font-weight:400;"><?= count($vertus) ?></span></h3>
